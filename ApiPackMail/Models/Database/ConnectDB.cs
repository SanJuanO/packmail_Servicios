...
namespace ConnectDB
{
    public class database
    {
        ...
        public string executeId()
        {
            ...
            try
            {
                ...
                command = new MySqlCommand("SELECT @@IDENTITY AS NEWSAMPLEID", connect);
        ...
        public string executeId(string query)
        {
            ...
            try
            {
                ...
                command = new MySqlCommand("SELECT scope_identity() AS NEWSAMPLEID", connect);
                MySqlDataReader reader = command.ExecuteReader();
                if (reader != null && reader.HasRows && reader.Read())
                {
                    LastId = this.getValueField(reader, "NEWSAMPLEID");
        ...
        /*  *
		public MySqlDataReader getRows(string sql)
		{
			try
			{
				connecttodb();
        ...
        public string getValueField(MySqlDataReader res, string campo)
        {
            int ordinal = res.GetOrdinal(campo);
            return getValueField(res, ordinal);
        }

        public static string getValueField(MySqlDataReader res, int ordinal)
        {
            string value = "";
    ...
    public class ResultSetX
    {
        ...
        public ResultSetX(MySqlDataReader reader)
        {
        ...
        public static object getValueFieldX(MySqlDataReader res, int ordinal)
        {
            object value = "";
            Type type = res.GetFieldType(ordinal);
            if (!res.IsDBNull(ordinal))
